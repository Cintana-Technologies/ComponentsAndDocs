        ...
        $scope.send = function(regData) {
            ...
            swal({
                ...
                .then((willSend) => {
                    if (willSend) {
                    	//rest api calling the webservices
                        commonFactory.sendmail(url,regData.selitem1.email_id, regData.selitem.email_content, regData.selitem.email_sub).then(function successCallback(response) {
                            refresh();
                        });
          ...
          //  console.log('smscall',regData);
            ...
            swal({
                ...
                .then((willSend) => {
                    if (willSend) {
                    	//rest api calling the webservices
                        commonFactory.sendsms(url,regData.selitem1.mobile_no, regData.selitem.sms_content).then(function successCallback(response) {
                            refresh();
                        });
