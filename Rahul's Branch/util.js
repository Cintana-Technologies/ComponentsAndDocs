...
var utils = {
    ...
    invokeRoleMappingbyid: function(user_id, roleid, flag, connection, mycallback) {
     ...
     //calling the Notification History procedure inside a function to perform insert operation 
     invokeNotificationHistoryInsert: function(notification_history, connection, mycallback) {
        console.log('sql');
        var sql = 'call sp_notification_history(' + "'" + JSON.stringify(notification_history) + "'"+ ')';
        console.log(sql);
        connection.query(sql, function(error, results) {
            if (error) {
                mycallback(error);
     ...
     //calling the Notification History procedure inside a function to perform insert operation 
     invokeGeneralDonorHistoryInsert: function(general_donor_history, connection, mycallback) {
        console.log('sql');
        var sql = 'call sp_general_donor_history(' + "'" + JSON.stringify(general_donor_history) + "'"+ ')';
        console.log(sql);
        connection.query(sql, function(error, results) {
            if (error) {
                mycallback(error);
    ...
    //calling the Notification History procedure inside a function to perform insert operation 
    invokeSponsorshipHistoryInsert: function(sponsorship_history, connection, mycallback) {
        console.log('sql');
        var sql = 'call sp_sponsorship_history(' + "'" + JSON.stringify(sponsorship_history) + "'"+ ')';
        console.log(sql);
        connection.query(sql, function(error, results) {
            if (error) {
                mycallback(error);
